...
/**
 * @ngdoc function
 * @name ndexCravatWebappApp.controller:VisualizeEnrichedCtrl
 * @description
 * # VisualizeEnrichedCtrl
 * Controller of the ndexCravatWebappApp
 */
angular.module('ndexCravatWebappApp')
  .controller('VisualizeEnrichedCtrl', function ($routeParams, $http, $scope, cyService, webServices, utils, cxNetworkUtils) {
