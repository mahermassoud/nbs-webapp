...
/**
 * @ngdoc directive
 * @name ndexCravatWebappApp.directive:cravatEnrichRequest
 * @description
 * # cravatEnrichRequest
 */
angular.module('ndexCravatWebappApp')
  .directive('cravatEnrichRequest', function ($location, $modal, $routeParams, networkListService) {
    return {
      templateUrl: 'views/templates/cravat-enrich-request-panel.html',
      restrict: 'E',
      link: function ($scope) {
